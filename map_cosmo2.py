#this version will be for higher frequency resolution
...
class MapCosmo():
    def __init__(self, mappath, feed=None, jk=None, split=None):
        ...
        self.map = self.map.transpose(4, 3, 0, 1, 2) * K2muK #it was: {4, 64, 16, 120, 120}, it becomes: {120,120,4,64,16}
        ...
        plt.figure()
        plt.imshow(self.map[0, :, 0:256], interpolation='none')
