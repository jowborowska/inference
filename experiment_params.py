...
n_pix_x = 30  # no of pixels
n_pix_y = 30

# should be calculated later
# sigma_T = 11.#2.75#1e9  # muK, noise Haavard
sigma_T = 12.55 #22.75 # 12.77  #7.41 #  11.07  # 19.97 #18.35 #11  # * np.sqrt(2)  # 11.0  # 11  # 41.5/np.sqrt(40)#23.25# MuK, Li,  2*11 = 1500 h
...
n_nu_bins = 256  # 100 number of frequency bins realistically 2^r
...
# model_params_cov['power_cov'] = [-1.9, 0.04, 10.25,
#                               12.0, 0.4]
model_params_cov['power_cov'] = [-2.75, 0.05, 10.61,
                                  12.3, 0.42]     # real
model_params_cov['power_cov_3par'] = [-2.75, 0.05, 10.6]     # real
# model_params_cov['power_cov'] = [-1.9, 0.04, 10.25,
#                               12.0, 0.4]  # oslo
